...
namespace ServicuerosSA.Controllers
{
    public class ClasificacionesController : Controller
    {
        ...
        private ClasificacionesModel claseModelosListaClasificaciones;
        public ClasificacionesController(ApplicationDbContext context)
        {
            _context = context;
            claseModelosListaClasificaciones = new ClasificacionesModel(context);
        }
        public List<Clasificacion> ControladorListaClasificaciones()
        {
