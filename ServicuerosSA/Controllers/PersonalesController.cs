...
namespace ServicuerosSA.Controllers
{
    public class PersonalesController : Controller
    {
        ...
        private PersonalModel clasemodelCedula;
        private PersonalModel clasemodelistapersonal;

        public PersonalesController(ApplicationDbContext context)
        {
            _context = context;
            clasemodelCedula = new PersonalModel(context);
            clasemodelistapersonal = new PersonalModel(context);

        }
        public List<object[]> Controladorlistapersonal()
        {
            return clasemodelistapersonal.Clasemodelistapersonal();
        }
        public List<IdentityError> ControladorCedulaPersonal(string cedula)
        {
            return clasemodelCedula.ClasemodelCedula(cedula);
        }
        public List<Personal> ControladorListaPersonalPerlambre()
        {
            return clasemodelCedula.ListaPersonal();
        }
        // GET: Personales
