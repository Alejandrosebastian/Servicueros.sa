...
namespace ServicuerosSA.Controllers
{
    public class TipoPielsController : Controller
    {
        ...
        private TipoPielModel claseModeloTipoPiel;
        public TipoPielsController(ApplicationDbContext context)
        {
            _context = context;
            claseModeloTipoPiel = new TipoPielModel(context);
        }

        public List<TipoPiel> ControladorTipoPielLista()
        {
            return claseModeloTipoPiel.ClaseModelListaTipoPiel();
        }
