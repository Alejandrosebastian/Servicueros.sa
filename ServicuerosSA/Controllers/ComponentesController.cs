...
namespace ServicuerosSA.Controllers
{
    public class ComponentesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ComponenteId,Detalle,Porcentaje,Tiempo,Cantidad,FormulaId,MedidaId")] Componente componente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ComponenteId,Detalle,Porcentaje,Tiempo,Cantidad,FormulaId,MedidaId")] Componente componente)
        {
