...
namespace ServicuerosSA.Controllers
{
    public class PelambresController : Controller
    {
        ...
        public List<IdentityError> ControladorGuardarPelambre(DateTime fecha, string obsrvaciones, int bodegaid, int bombo, int formula, int peso, int personal, string codlote)
        {
            return clasePelambre.ClaseGuardaPelambre(fecha, obsrvaciones, bodegaid, bombo, formula, peso, personal, codlote);
        }
