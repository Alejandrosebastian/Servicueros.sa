...
namespace ServicuerosSA.Controllers
{
    public class BodegasController : Controller
    {
        ...
        private BodegaModel claseBodegamodel;
        ...
        public List<object[]> ControladorBodega(int bodegaId)
        {
            return claseBodegamodel.ClaseBodega(bodegaId);
        }
        // GET: Bodegas
        public async Task<IActionResult> Index()
        {
            var dato = _context.Bodega.Include(c => c.TiposBodega);
            return View(await dato.ToListAsync());
        }
        ...
        {
            ViewData["TipoBodegaId"] = new SelectList(_context.Set<TipoBodega>(), "TipoBodegaId", "Detalle");
            return View();
        }
